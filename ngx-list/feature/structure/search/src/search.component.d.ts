...
export declare class SearchComponent extends SmartComponent implements OnInit {
    ...
    constructor(formBuilder: FormBuilder, changeDetectorRef: ChangeDetectorRef, elementRef: ElementRef, effects: GuiEffects, structureId: StructureId, searchCommandDispatcher: SearchPublisher, searchWarehouse: SearchWarehouse);
    ngOnInit(): void;
    clear(): void;
