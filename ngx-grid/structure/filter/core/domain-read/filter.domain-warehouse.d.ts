...
export declare class FilterDomainWarehouse extends FilterWarehouse {
    ...
    constructor(filterEnabledArchive: FilterEnabledArchive, structureQuickFilterRepository: QuickFilterEnabledArchive, filterTypeArchive: FilterTypeArchive, uniqueValuesArchive: UniqueValueCollectionArchive, activeFilterArchive: ActiveFilterArchive);
