    ...
    ***************************************************************************** */
    ...
    var FabricDatePickerService = /** @class */ (function () {
        function FabricDatePickerService() {
            this.dateMonth$ = new rxjs.Subject();
            this.dateYear$ = new rxjs.Subject();
            this.initialDate = new Date();
            this.selectedDate$ = new rxjs.BehaviorSubject(this.initialDate);
        }
        /**
         * @return {?}
         */
    ...
    var FabricSelectComponent = /** @class */ (function () {
        function FabricSelectComponent(platformId, elementRef, renderer, changeDetectorRef) {
            ...
            this.width = 100;
            this.disabled = false;
            this.optionChanged = new core.EventEmitter();
