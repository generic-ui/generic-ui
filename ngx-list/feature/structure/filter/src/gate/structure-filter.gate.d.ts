...
export declare class StructureFilterGate extends Gate implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<StructureFilterGate, "gui-structure[filtering]", never, { "filtering": { "alias": "filtering"; "required": false; }; }, {}, never, never, false, never>;
}
