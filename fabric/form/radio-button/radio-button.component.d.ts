...
export declare class FabricRadioButtonComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FabricRadioButtonComponent, "gui-radio-button", never, { "name": "name"; "checked": "checked"; "disabled": "disabled"; }, { "changed": "changed"; }, never, ["*"], false>;
}
