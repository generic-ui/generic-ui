...
FabricDatePickerViewPanelComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: FabricDatePickerViewPanelComponent, deps: [{ token: i1.FabricDatePickerCalendarViewService }, { token: i2.FabricDatePickerCalendarService }, { token: i3.FabricDatePickerYearsService }, { token: i4.FabricDatePickerYears }], target: i0.ɵɵFactoryTarget.Component });
FabricDatePickerViewPanelComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.3.11", type: FabricDatePickerViewPanelComponent, selector: "gui-date-picker-view-panel", inputs: { fabricCalendarView: "fabricCalendarView", selectedDate: "selectedDate", activeMonth: "activeMonth", activeYear: "activeYear", years: "years" }, ngImport: i0, template: `
	...
	`, isInline: true, components: [{ type: i5.FabricArrowIconComponent, selector: "gui-arrow-icon", inputs: ["direction"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
