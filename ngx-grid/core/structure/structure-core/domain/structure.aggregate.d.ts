...
import { SourceManager } from '../../source/domain/source.manager';
import { VerticalFormation } from '../../vertical-formation/domain/vertical-formation';
import { SummariesManager } from '../../summaries/domain/summaries.manager';
import { SorterManager } from '../../sorting/domain/sorter.manager';
import { FilterManager } from '../../filter/domain/filter.manager';
import { FieldCollection } from '../../field/domain/field-collection';
import { FormationManager } from '../../formation/domain/formation.manager';
import { StructureId } from '../api/global/structure.id';
import { StructureEditSourceItemParams } from '../../source/core/origin/edit/structure.edit-source-item.params';
import { PagingConfig } from '../../paging/api/config/paging-config';
import { OriginItemEntity } from '../../source/domain/origin/origin-item-entity';
import { SortingConfig } from '../../sorting/api/config/sorting-config';
import { FieldId } from '../../field/domain/field/field.id';
import { Sorter } from '../../sorting/domain/sorter';
...
import { FieldConfig } from '../../field/api/config/field.config';
import { FilterTypeId } from '../../filter/domain/type/filter-type.id';
import { FilterId } from '../../filter/api/id/filter.id';
...
import { RowSelectToggleType } from '../../formation/domain/row-select-toggle-type';
import { RowSelectionMode } from '../../formation/api/row-selected/row-selection';
