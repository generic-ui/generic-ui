...
export declare class StructureInfoPanelGate extends Gate implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<StructureInfoPanelGate, "gui-structure[infoPanel]", never, { "infoPanel": { "alias": "infoPanel"; "required": false; }; }, {}, never, never, false, never>;
}
