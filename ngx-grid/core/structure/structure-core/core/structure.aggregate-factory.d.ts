...
export declare class StructureAggregateFactory extends AggregateFactory<StructureId, StructureAggregate> {
    ...
    static readonly services: (typeof PagingManagerFactory | typeof FilterManagerFactory | typeof SearchManagerFactory | typeof FieldCollectionFactory | typeof SourceManagerFactory | typeof SummariesManagerFactory | typeof VerticalFormationFactory)[];
