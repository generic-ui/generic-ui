...
export declare class FabricRatingComponent implements OnChanges, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FabricRatingComponent, "gui-rating", never, { "starsLength": { "alias": "starsLength"; "required": false; }; "rating": { "alias": "rating"; "required": false; }; }, { "onRatingChange": "onRatingChange"; }, never, never, false, never>;
}
