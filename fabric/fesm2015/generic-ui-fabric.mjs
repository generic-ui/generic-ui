...
FabricNotificationsOverlayComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.3", ngImport: i0, type: FabricNotificationsOverlayComponent, deps: [{ token: i0.ChangeDetectorRef }, { token: i0.ElementRef }, { token: i0.Renderer2 }, { token: FabricModalThemeService }, { token: themeToken }, { token: forwardRef(() => FabricNotificationService) }], target: i0.ɵɵFactoryTarget.Component });
