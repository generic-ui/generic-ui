...
export { AggregateCommandHandlerImpl as ɵx, aggregateCommandHandlerFactory as ɵw } from './domain/command/aggregate/create/aggregate-command-handler.impl';
export { AGGREGATE_COMMAND_HANDLERS as ɵp } from './domain/command/aggregate/create/aggregate-command-handlers.token';
