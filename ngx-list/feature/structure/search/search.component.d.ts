...
export declare class SearchComponent extends SmartComponent implements OnInit {
    ...
    constructor(formBuilder: FormBuilder, changeDetectorRef: ChangeDetectorRef, elementRef: ElementRef, structureId: StructureId, searchCommandDispatcher: SearchPublisher, structureWarehouse: StructureWarehouse, searchWarehouse: SearchWarehouse);
    ngOnInit(): void;
    clear(): void;
