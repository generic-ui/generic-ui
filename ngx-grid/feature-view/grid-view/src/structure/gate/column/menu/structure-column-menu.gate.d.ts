...
export declare class StructureColumnMenuGate extends Gate implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<StructureColumnMenuGate, "gui-structure[columnMenu]", never, { "columnMenu": { "alias": "columnMenu"; "required": false; }; }, {}, never, never, false, never>;
}
