...
import { NgChanges } from '../../cdk/component/ng-changes';
...
export declare class StructureArrowIconComponent extends IconComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StructureArrowIconComponent, "div[gui-structure-arrow-icon]", never, { "position": "position"; "sort": "sort"; }, {}, never, never>;
}
