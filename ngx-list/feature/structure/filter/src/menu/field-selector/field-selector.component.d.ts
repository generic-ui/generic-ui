...
export declare class FieldSelectorComponent extends PureComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FieldSelectorComponent, "div[gui-field-selector][fields]", never, { "fields": { "alias": "fields"; "required": false; }; }, { "fieldSelected": "fieldSelected"; }, never, never, false, never>;
}
