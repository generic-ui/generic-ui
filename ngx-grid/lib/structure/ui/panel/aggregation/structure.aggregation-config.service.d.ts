...
export declare class StructureAggregationConfigService {
    ...
    private structureId;
    constructor(structureAggregationPanelConfigConverter: StructureAggregationPanelConfigConverter, structureAggregationArchive: StructureAggregationArchive, structureAggregationCommandService: StructureAggregationCommandDispatcher, structureId: StructureId);
