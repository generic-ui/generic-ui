...
export declare class FabricToggleButtonComponent extends Indicator {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FabricToggleButtonComponent, "gui-button-toggle", never, { "checked": "checked"; "disabled": "disabled"; }, { "changed": "changed"; }, never, ["*"], false>;
}
