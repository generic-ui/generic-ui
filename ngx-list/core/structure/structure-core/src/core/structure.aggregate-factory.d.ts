...
export declare class StructureAggregateFactory extends AggregateFactory<StructureId, StructureAggregate> {
    ...
    static readonly services: (typeof PagingManagerFactory | typeof SearchManagerFactory | typeof FilterManagerFactory | typeof FieldCollectionFactory | typeof SummariesManagerFactory | typeof VerticalFormationFactory | typeof SourceManagerFactory)[];
