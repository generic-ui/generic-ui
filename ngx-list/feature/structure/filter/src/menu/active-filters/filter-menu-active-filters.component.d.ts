...
export declare class FilterMenuActiveFiltersComponent extends PureComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FilterMenuActiveFiltersComponent, "div[gui-filter-menu-active-filters][activeFilters]", never, { "activeFilters": { "alias": "activeFilters"; "required": false; }; }, { "removedFilter": "removedFilter"; }, never, never, false, never>;
}
