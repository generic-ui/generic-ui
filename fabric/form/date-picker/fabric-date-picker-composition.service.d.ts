...
export declare class FabricDatePickerCompositionService {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<FabricDatePickerCompositionService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<FabricDatePickerCompositionService>;
}
