...
export declare class ListViewItemComponent extends PureComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ListViewItemComponent, "div[gui-list-view-item][item][template]", never, { "item": { "alias": "item"; "required": false; }; "template": { "alias": "template"; "required": false; }; }, {}, never, never, false, never>;
}
