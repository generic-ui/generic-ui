...
export declare const compositionProviders: (typeof CompositionDispatcher | typeof CompositionCommandDispatcher | typeof CompositionReadModelWarehouse | typeof CompositionEventRepository | typeof ColumnPresentationConverter | typeof ColumnEntityFactory | typeof import("../infrastructure/in-memory/in-memory.composition.store").InMemoryCompositionStore | typeof import("../../../generic-ui-ngx-grid").ɵfs | typeof ViewTemplateFactory | typeof ViewTemplateRepository | typeof EditTemplateFactory | typeof EditTemplateRepository | typeof ColumnDefinitionFactory | typeof CompositionReadModelRootConverter | typeof import("../../../generic-ui-ngx-grid").ɵgj | {
    provide: typeof import("../domain/composition.aggregate-repository").CompositionAggregateRepository;
    useClass: typeof import("../../../generic-ui-ngx-grid").ɵfq;
} | {
    provide: typeof import("../read/composition.read-model-root-repository").CompositionReadModelRootRepository;
    useClass: typeof import("../../../generic-ui-ngx-grid").ɵgr;
