...
import { StructureDetailViewService } from './row-detail/structure.detail-view.service';
/** @internal */
...
export declare const structureComponentSelfProviders: (typeof StructurePagingDisplayModeArchive | {
    ...
    provide: typeof import("../../../generic-ui-ngx-grid").ɵes;
