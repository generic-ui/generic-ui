...
export declare class FabricDatePickerMonthsViewComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FabricDatePickerMonthsViewComponent, "gui-date-picker-months-view", never, { "selectedDate": { "alias": "selectedDate"; "required": false; }; "activeYear": { "alias": "activeYear"; "required": false; }; }, {}, never, never, false, never>;
}
