...
export declare class StructureColumnConfigColumnMoveComponent extends PureComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StructureColumnConfigColumnMoveComponent, "div[gui-structure-column-config-column-move][column]", never, { "column": { "alias": "column"; "required": false; }; }, { "movedLeft": "movedLeft"; "movedRight": "movedRight"; }, never, never, false, never>;
}
