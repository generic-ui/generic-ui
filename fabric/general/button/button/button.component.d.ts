...
export declare class FabricButtonComponent extends Indicator {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FabricButtonComponent, "button[gui-button], a[gui-button]", never, { "link": { "alias": "link"; "required": false; }; "text": { "alias": "text"; "required": false; }; }, {}, never, ["*"], false, never>;
}
