...
export declare class StringEditTemplateComponent extends InputEditTemplateComponent<string> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StringEditTemplateComponent, "gui-string-edit", never, {}, {}, never, never>;
}
//# sourceMappingURL=string-edit-template.component.d.ts.map