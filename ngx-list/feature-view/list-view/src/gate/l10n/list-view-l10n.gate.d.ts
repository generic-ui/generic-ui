...
export declare class ListViewL10nGate extends Gate implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ListViewL10nGate, "gui-list-view[localization]", never, { "localization": { "alias": "localization"; "required": false; }; }, {}, never, never, false, never>;
}
