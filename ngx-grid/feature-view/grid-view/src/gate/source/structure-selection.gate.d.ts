...
export declare class StructureSelectionGate extends SelectionGate {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<StructureSelectionGate, "gui-structure[rowSelection], gui-structure[selectionGate]", never, { "selectionGate": "selectionGate"; }, {}, never, never, false>;
}
