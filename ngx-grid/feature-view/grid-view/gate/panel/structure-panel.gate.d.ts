...
export declare class StructurePanelGate extends Gate implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<StructurePanelGate, "gui-structure[titlePanel][footerPanel]", never, { "titlePanel": "titlePanel"; "footerPanel": "footerPanel"; }, {}, never, never, false>;
}
